#!/usr/bin/env python3
"""
Create demo SVG/GIF animations for Portsy CLI
"""
...
def create_demo_output():
    """Generate sample demo output for README"""
    demo_text = '''
...
def create_ascii_art():
    """Create ASCII art logo for Portsy"""
    logo = '''
 ██▓███   ▒█████   ██▀███  ▄▄▄█████▓  ██████▓██   ██▓
▓██░  ██▒▒██▒  ██▒▓██ ▒ ██▒▓  ██▒ ▓▒▒██    ▒ ▒██  ██▒
▓██░ ██▓▒▒██░  ██▒▓██ ░▄█ ▒▒ ▓██░ ▒░░ ▓██▄    ▒██ ██░
...
def main():
    """Create demo assets"""
    print("🎬 Creating Portsy demo assets...")
    
    # Create demo directory
    os.makedirs('demo', exist_ok=True)
    
    # Write demo output
    with open('demo/sample_output.txt', 'w') as f:
        f.write(create_demo_output())
    
    # Write ASCII logo
    with open('demo/logo.txt', 'w') as f:
        f.write(create_ascii_art())
    
    # Create markdown with demo
    demo_md = f'''# Portsy Demo Output
...
'''
    ...
    print("✅ Demo assets created:")
    print("   📁 demo/sample_output.txt")
    print("   📁 demo/logo.txt") 
